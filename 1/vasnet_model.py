...
class SelfAttention(nn.Module):
    ...
    def __init__(self, apperture=-1, ignore_itself=False, input_size=2048, output_size=2048):
...
class VASNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.ka = nn.Linear(in_features=self.m, out_features=2048)
        self.kb = nn.Linear(in_features=self.ka.out_features, out_features=2048)
        self.kc = nn.Linear(in_features=self.kb.out_features, out_features=2048)
